...
const Header = ({ data }) => {
  ...
  return (
    <>
      <div
        class='bg-[url("https://images3.alphacoders.com/589/589870.jpg")] h-screen w-full bg-cover bg-center'
        id="Home">
        <header id="home">
          <nav id="nav-wrap">
              ...
              <div class="flex flex-col justify-center items-center ">
                <ul  >
                  <a className="smoothscroll" href="#home"
                    class="py-2 pr-4 pl-3 text-gray-300   font-semibold ">Home</a>
                  <a className="smoothscroll" href="#about"
                    class=" py-2 pr-4 pl-3 text-gray-300   font-semibold">About</a>
                  <a className="smoothscroll" href="#resume"
                    class=" py-2 pr-4 pl-3 text-gray-300  font-semibold">Resume</a>
                  <a className="smoothscroll" href="#portfolio" 
                    class=" py-2 pr-4 pl-3 text-gray-300   font-semibold">Portfolio</a>
                  <a className="smoothscroll" href="#contact"
                    class=" py-2 pr-4 pl-3 text-gray-300  font-semibold">Contact</a>
                </ul>
              </div>
          ...
          <div className="row banner">
            <div className="banner-text">
              <h1 class="mb-2 pt-64 text-5xl font-bold text-center text-white" >

                {name ? `I'm ${name}.` : null}
              </h1>
              <h2 class="text-3xl text-center pt-4 text-white">
               Im living in {city}. <span>{occupation}</span>. {description}.
              </h2>
              {/* <ul className="social">{networks}</ul> */}
            </div>
          </div><br />
          <div class="flex mt-4 space-x-10 sm:justify-center sm:mt-0 ">
            <a href="https://www.facebook.com/Nandhini Ukesh" class="text-white hover:text-white dark:hover:text-white">
            ...
            <a href="http://www.instagram.com/in/nandhu_ukesh" class="text-white hover:text-white dark:hover:text-white">
            ...
            <a href="https://github.com/Nandhini1997-web" class="text-white hover:text-white dark:hover:text-white">
            ...
            <a href="https://twitter.com/?lang=en-in" class="text-white hover:text-white dark:hover:text-white">
