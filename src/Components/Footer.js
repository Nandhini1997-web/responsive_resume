                    ...
                    <div className="row">
                        <div className="twelve columns">
                            <div class="flex mt-4 space-x-10 sm:justify-center sm:mt-0">
                                <a href="https://www.facebook.com/Nandhini Ukesh" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray">
                                ...
                                <a href="http://www.instagram.com/in/nandhu_ukesh" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray">
                                ...
                                <a href="https://github.com/Nandhini1997-web" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray">
                                ...
                                <a href="https://twitter.com/?lang=en-in" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray">
                            ...
                            <h2 class="text-center text-gray-500 dark:text-gray-400 text-center-full text-lg font-bold">
                                Made by {"NANDHINI !!!"}
                            </h2>
                        </div>
                        <br />
